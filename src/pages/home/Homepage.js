...
import UserResearch from "../../components/user-research-container/UserResearch";
  ...
  return (
    <div id="container">
      <div className="container-home flex justify-center min-h-screen mx-auto max-w-7xl px-6 sm:px-8 lg:px-6">
        {/* <div className="h-96 w-[640px] bg-indigo-500 absolute blur-[140px] -z-[100] -translate-x-[60rem] translate-y-[40rem]"></div> */}
        {/* <div className="h-96 w-96 bg-indigo-500 absolute blur-[240px] -z-[100]"></div> */}
